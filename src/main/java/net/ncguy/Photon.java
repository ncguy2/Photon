...
public class Photon {
    ...
    public static final Vector3 targetOrigin = new Vector3();
    public static final Vector3 targetStepSize = new Vector3();

    public static final Vector3 actualOrigin = new Vector3();
    public static final Vector3 actualStepSize = new Vector3();
    public static final Vector3 actualExtents = new Vector3();
    public static float globalLightIntensity = 8;

    public static int volumeTextureHandle = -1;
    public static List<SamplePoint> samplePoints;

    public static void BuildTexture(final List<PWorld.Triangle> tris, List<PLight> lights, int resolution) {
        BuildTexture(tris, lights, resolution, targetOrigin, targetStepSize);
    }

    public static void BuildTexture(final List<PWorld.Triangle> tris, List<PLight> lights, int resolution, Vector3 origin, Vector3 stepSize) {
    ...
    public static void BuildTexture(ByteBuffer texels, int resolution) {
    ...
    public static ByteBuffer GetTexelData(List<SamplePoint> samplePoints, int resolution) {
    ...
    public static List<SamplePoint> GetSamplePoints(final List<PWorld.Triangle> tris, List<PLight> lights, int resolution, Vector3 origin, Vector3 stepSize) {
    ...
    public static Color SamplePointVisibility(Vector3 point, List<PLight> lightPositions, final List<PWorld.Triangle> tris) {
    ...
    public static Color getLightInfluence(Vector3 point, List<PWorld.Triangle> tris, PLight light) {
    ...
    public static boolean intersects(Ray ray, List<PWorld.Triangle> tris) {
        return intersects(ray, tris, null);
    }

    public static boolean intersects(Ray ray, List<PWorld.Triangle> tris, Vector3 intersection) {
